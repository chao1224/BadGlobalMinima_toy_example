...
if __name__ == '__main__':
    ...
    data = np.load('../datasets/confusion_data.npz')
    ...
    train(model, train_data, train_label, test_data, test_label, criterion, interval=100)

    with open('pre_train_model.pt', 'wb') as f_:
